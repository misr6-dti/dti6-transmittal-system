...
<div class="mb-5">
    ...
    <h2 class="fw-extrabold mb-0">Frequently Asked Questions</h2>
    <p class="text-muted">Learn more about the DTI-R6 Transmittal Management System.</p>
</div>
        ...
        <div class="accordion accordion-flush card shadow-sm border-0 rounded-4 overflow-hidden" id="faqAccordion">
            ...
            <div class="accordion-item border-bottom">
                ...
                <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                    <div class="accordion-body p-4 text-muted lh-relaxed">
