...
<body>
    ...
    <div class="container text-center py-4 no-print">
        <p class="small mb-0" style="color: rgba(255,255,255,0.6);">&copy; 2026 DTI Region VI - Transmittal Management
            System. All rights reserved. | Developed by DTI Region VI MIS</p>
    </div>
</body>
