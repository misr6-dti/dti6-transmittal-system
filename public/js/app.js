...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('confirm', {
  open: false,
  action: '',
  method: 'POST',
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('notifications', function () {
  return {
    count: 0,
    unread: [],
    open: false,
    ...
    init: function init() {
      ...
      setInterval(function () {
        return _this.fetchCount();
      }, 30000);
    },
    fetchCount: function fetchCount() {
      var _this2 = this;
      fetch("".concat(this.appUrl, "/notifications/unread-count"), {
        ...
        return console.error('Notification count error:', e);
      });
    },
    fetchList: function fetchList() {
      ...
      this.open = !this.open;
      if (this.open) {
        fetch("".concat(this.appUrl, "/notifications/unread"), {
          headers: this._headers()
        }).then(function (res) {
          if (!res.ok) throw new Error(res.status);
          return res.json();
          ...
          return console.error('Notification list error:', e);
        });
      }
    },
    markRead: function markRead(id, link) {
      var _this4 = this;
      fetch("".concat(this.appUrl, "/notifications/").concat(id, "/read"), {
        method: 'POST',
        ...
        if (!res.ok) throw new Error(res.status);
        if (link) window.location.href = link;else {
          _this4.fetchCount();
          _this4.fetchList();
        }
      })["catch"](function (e) {
        return console.error('Notification mark-read error:', e);
      });
    }
  };
});
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('toast', {
  items: [],
  _counter: 0,
  ...
  dismiss: function dismiss(id) {
    ...
    setTimeout(function () {
      _this6.items = _this6.items.filter(function (i) {
        return i.id !== id;
      });
    }, 400);
  }
...
document.addEventListener('click', function (e) {
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].store('confirm').show({
